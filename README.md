...
**Part 1 due: Monday, January 12th 11:59PM**

**Due: Wednesday, January 21st 11:59 PM**
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-26wi/simple-db-MY_GITLAB_USERNAME.git
...
$ git remote add upstream git@gitlab.cs.washington.edu:cse444-26wi/simple-db.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse444-26wi/simple-db-username.git (fetch)
  origin  git@gitlab.cs.washington.edu:cse444-26wi/simple-db-username.git (push)
  upstream    git@gitlab.cs.washington.edu:cse444-26wi/simple-db.git (fetch)
  upstream    git@gitlab.cs.washington.edu:cse444-26wi/simple-db.git (push)
```
...
To git@gitlab.cs.washington.edu:cse444-26wi/simple-db-username.git
...
From gitlab.cs.washington.edu:cse444-26wi/simple-db
...
Make sure to submit part 1 for full credit. We will NOT run any of the unit
tests for part 1. We will just visually inspect that you submitted something
reasonably complete.

After executing the `turnInLab.sh` script, make sure to check your repository on GitLab to ensure that the tag has been property applied!  You may do this by visiting `https://gitlab.cs.washington.edu/cse444-26wi/simple-db-YOUR_USERNAME/tags`.
...
To git@gitlab.com:cse444-26wi/hw-answers-pirateninja.git
 - [deleted]         lab1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-26wi/simple-db-username.git confirmation_directory
