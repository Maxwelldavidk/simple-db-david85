...
### Due: Thursday, March 19th, 2026 (hard deadline, no late days allowed)
...
The optimizer will be invoked from `simpledb/Parser.java`. You may wish to review the [lab 2 parser exercise](https://gitlab.cs.washington.edu/cse444-26wi/simple-db/blob/lab2/README.md) before starting this lab. Briefly, if you have a catalog file `catalog.txt` describing your tables, you can run the parser by typing:
...
https://courses.cs.washington.edu/courses/cse444/26wi/content/Project.html
...
To git@gitlab.com:cse444-26wi/simple-db-pirateninja.git
 - [deleted]         lab5
...
To git@gitlab.com:cse444-26wi/hsimple-db-pirateninja.git
 * [new tag]         lab5 -> lab5
```
